      ...
      <div class="group grid gap-8 md:grid-cols-3 transition-all duration-500">
        ...
        <div class="bg-blue-500 bg-opacity-30 rounded-3xl p-8 text-center transition-all duration-500 
          ...
          <div class="bg-blue-600 w-16 h-16 rounded-full flex items-center justify-center mb-6 mx-auto transition-all
            ...
            <img src="/assets/icons/clean-teeth.svg" alt="clean-teeth" loading="lazy" decoding="async" class="invert w-10 h-10"/>
          </div>
        ...
        <div class="bg-blue-500 bg-opacity-30 rounded-3xl p-8 text-center transition-all duration-500 
          ...
          <div class="bg-blue-600 w-16 h-16 rounded-full flex items-center justify-center mb-6 mx-auto transition-all
                      group-hover:bg-blue-700">
            <img src="/assets/icons/implant.svg" alt="teeth-implant" loading="lazy" decoding="async" class="invert w-10 h-10"/>
          </div>
        ...
        <div class="bg-blue-500 bg-opacity-30 rounded-3xl p-8 text-center transition-all duration-500 
          ...
          <div class="bg-blue-600 w-16 h-16 rounded-full flex items-center justify-center mb-6 mx-auto transition-all
                      group-hover:bg-blue-700">
            <img src="/assets/icons/tooth-_1_.svg" alt="toothexam" loading="lazy" decoding="async" class="invert w-10 h-10"/>
          </div>
