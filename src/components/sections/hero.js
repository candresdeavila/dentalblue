          ...
          <div class="lg:hidden">
            <div class="max-w-2xl">
              ...
              <h1 data-animate class="mt-6 text-5xl sm:text-6xl font-extrabold leading-[0.95] text-slate-900">
                ${t("hero.home.titleLine1")}<br>
                <span class="text-blue-700">${t("hero.home.titleHighlight")}</span> ${t("hero.home.titleLine2")}<br>
                ${t("hero.home.titleLine3")}
              </h1>
              <p data-animate class="mt-6 max-w-xl text-lg leading-8 text-slate-600">
                ${t("hero.home.paragraph")}
              </p>
              <div class="mt-8 flex flex-wrap items-center gap-4">
                <a href="#services" class="inline-flex items-center justify-center rounded-2xl bg-blue-700 px-8 py-4 font-semibold text-white shadow-[0_16px_35px_rgba(29,78,216,0.22)] transition-colors hover:bg-blue-800">
                  ${t("hero.home.primaryCta")}
                </a>
                <a href="${whatsappHref}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center rounded-2xl bg-slate-200 px-8 py-4 font-semibold text-slate-800 transition-colors hover:bg-slate-300">
            ...
            <div class="mt-10 flex justify-center">
              <div class="relative w-full max-w-md overflow-hidden rounded-[2rem] shadow-[0_24px_70px_rgba(15,23,42,0.18)]">
                <img src="/assets/images/hero/dentista-haciendo-un-chequeo-al-paciente.webp" alt="${t("common.dentistAlt")}" class="block h-[470px] w-full object-cover" style="object-position: 60% 30%;">
          ...
          <div class="hidden lg:grid lg:grid-cols-[minmax(0,1fr)_560px] lg:items-center lg:gap-12">
            <div class="max-w-[560px]">
              ...
              <div class="mt-10 flex items-center gap-4">
                <a href="#services" class="inline-flex items-center justify-center gap-3 rounded-[1.7rem] bg-blue-700 px-8 py-4 text-lg font-semibold text-white shadow-[0_16px_40px_rgba(29,78,216,0.22)] transition-colors hover:bg-blue-800">
                  ${t("hero.home.primaryCta")}
                ...
                <a href="${whatsappHref}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center rounded-[1.7rem] bg-slate-200 px-8 py-4 text-lg font-semibold text-slate-800 transition-colors hover:bg-slate-300">
                  ${t("hero.home.secondaryCta")}
                </a>
              </div>
            ...
            <div class="relative flex justify-end">
              ...
              <div class="relative w-full max-w-[560px] overflow-hidden rounded-[2rem] shadow-[0_28px_90px_rgba(15,23,42,0.18)]">
                <img src="/assets/images/hero/dentista-haciendo-un-chequeo-al-paciente.webp" alt="${t("common.dentistAlt")}" class="block h-[700px] w-full object-cover" style="object-position: 62% 28%;">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 data-animate class="text-4xl sm:text-5xl font-extrabold text-gray-900 leading-tight mb-6">
                  ${t("hero.about.titlePrefix")} <span class="${aboutHighlightClass}">${t("hero.about.titleHighlight")}</span>
                </h1>
